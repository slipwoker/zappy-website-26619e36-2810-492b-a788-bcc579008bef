    ...
    if (contactForm) {
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
          ...
          .catch(error => {
            showError(contactForm, 'Something went wrong. Please try again later.');
          })
          .finally(() => {
            if (submitBtn) {
      ...
      function showSuccessMessage(form, message) {
        ...
        successElement.style.cssText = 'background: #c6f6d5; color: #276749; padding: 1rem; border-radius: 0.375rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '26619e36-2810-492b-a788-bcc579008bef',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '26619e36-2810-492b-a788-bcc579008bef';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '26619e36-2810-492b-a788-bcc579008bef';
